...
[^3]: If the Tension Water storage of the Lower Zone is completely full, then percolation goes entirely to the 2 Free Water storages.
...
![Descriptive sketch for parameters used in the calculation of I~1~](figures/fig-model_channel_routing_st_venant_1.png){#fig-model_channel_routing_st_venant_1}
